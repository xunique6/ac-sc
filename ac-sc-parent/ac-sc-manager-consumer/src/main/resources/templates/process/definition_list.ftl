...
<form class="form-inline" role="form" style="float:left;">
  ...
  <button type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
	...
	<form action="/consumer/process/upload" method="post" id="uploadForm"  enctype="multipart/form-data" style="display:none"> 
		<input type="file" id="uploadBlock" name="bpnmFile" />
	</form>

		<button  id="uploadBtn"   class="btn btn-primary" style="float:right;">
